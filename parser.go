...
func getLength(node *xmlquery.Node) int32 {
	return getIntText(getHeadText(xmlquery.Find(node, "/LENGTH")))
}
...
func getHexIntValue(str string) (uint64, error) {
	if isHexString(str) {
	...
	return 0, errors.New("not a hex string")
